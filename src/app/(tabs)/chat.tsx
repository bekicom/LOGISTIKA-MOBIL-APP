/** Chat — keyingi bosqichda quriladi. */
...
export default function Screen() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top }]}>
      ...
      <View style={s.body}>
        <Empty icon="chat" title="Hali tayyor emas" text="Suhbatlar F bo'limida quriladi — xabar almashish, ovozli xabar, hujjat yuborish." />
      </View>
    </View>
  );
}
